 ...
 * @version 1.0.0
 */
package benkuper.nativeExtensions.airBonjour
{
	...
	public class Bonjour extends EventDispatcher {
		...
		public function Bonjour() {
			if (!_isInstantiated) {
				...
				_context = ExtensionContext.createExtensionContext("benkuper.nativeExtensions.airBonjour", "");
				trace(ExtensionContext.getExtensionDirectory("benkuper.nativeExtensions.airBonjour").nativePath);
